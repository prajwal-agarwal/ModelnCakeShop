...
export default function Cakedetails() {
  ...
  useEffect(() => {
    axios({
      ...
      console.log("cake : " + JSON.stringify(response.data.data))
  ...
  function addToCart() {
    ...
    axios({
      utl: "http://apibyauw.eu-4.evennode.com/api" + "addcaketocart",
      method:"post",
      data:requestJson,
      headers:{
        ...
        <Col xs={10}>
          {cake && (
            <div style={{ maxWidth: '100%', maxHeight: '100%', marginLeft: '300px', marginTop: '100px' }}>
              ...
              <Button type="primary" onClick={addToCart.bind(null, cake)}>Add to Cart</Button>
            </div>
          )}
        </Col>
